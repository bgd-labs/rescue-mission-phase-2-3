...
deploy-opt-contracts :; forge script scripts/OptDeploy.s.sol:OptDeploy --rpc-url ${RPC_OPTIMISM} --broadcast --legacy --ledger --mnemonic-indexes ${MNEMONIC_INDEX} --sender ${LEDGER_SENDER} --etherscan-api-key ${ETHERSCAN_API_KEY_OPTIMISM} --gas-estimate-multiplier 100 --verify -vvvv

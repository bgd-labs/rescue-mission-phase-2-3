...
<img width="1042" alt="Screenshot 2023-07-29 at 5 38 07 PM" src="https://github.com/bgd-labs/rescue-mission-phase-2-3/assets/22850280/fbb1b3c0-abfd-40bd-81e8-7f82f61efd22">
...
This script also generates a [resume](https://github.com/bgd-labs/rescue-mission-phase-2-3/blob/test/claims/js-scripts/maps/amountsByContract.txt) indicating the amount to rescue for every token sent on the contracts. Tokens with value less than $1000 are ignored.
...
Example of a generated file from this command - [usdtRescueMap.json](https://github.com/bgd-labs/rescue-mission-phase-2-3/blob/test/claims/js-scripts/maps/ethereum/usdtRescueMap.json)
...
Example of a generate file from this command: [usdtRescueMerkleTree.json](https://github.com/bgd-labs/rescue-mission-phase-2-3/blob/test/claims/js-scripts/maps/ethereum/merkleTree/usdtRescueMerkleTree.json)
...
Example of a generated file from this command: [usdtRescueMapFormatted.json](https://github.com/bgd-labs/rescue-mission-phase-2-3/blob/test/claims/js-scripts/maps/ethereum/formatted/usdtRescueMapFormatted.json)
...
Example of a generated file from this command: [usersMerkleTrees.json](https://github.com/bgd-labs/rescue-mission-phase-2-3/blob/test/claims/js-scripts/maps/ethereum/usersMerkleTrees.json)

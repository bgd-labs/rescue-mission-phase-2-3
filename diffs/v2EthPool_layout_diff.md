```diff
diff --git a/reports/v2EthPool_layout.md b/reports/rescue_v2EthPool_layout.md
index 6c5b99d..d4b8363 100644
--- a/reports/v2EthPool_layout.md
+++ b/reports/rescue_v2EthPool_layout.md
@@ -1,11 +1,11 @@
...
-etherscan/v2EthPool/LendingPool/contracts/protocol/lendingpool/LendingPool.sol:LendingPool
+src/contracts/v2EthPool/LendingPool/contracts/protocol/lendingpool/LendingPool.sol:LendingPool
  |
~
